...
class Plate extends StatelessWidget {
  ...
  const Plate(this.padding, this.image, this.alignment,{Key? key}) : super(key: key);
  @override
...
class TheFood extends StatefulWidget {
  ...
  const TheFood(this.foodPageType, this.state,{Key? key}) : super(key: key);
...
class _TheFoodState extends State<TheFood> {
  ...
  Widget build(BuildContext context) {
    BoxDecoration boxDecoration = BoxDecoration(
        color: const Color.fromRGBO(72, 140, 159, 1),
        boxShadow: const [
          BoxShadow(
          ...
          child: Align(
            ...
            child: Stack(
              children: [
                ...
                Plate(true, widget.state.selectedFood.image, const Alignment(1.5, 0)),
              ],
            ),
          ),
        );
